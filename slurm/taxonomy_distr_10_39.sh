...
#SBATCH --job-name=taxonomy_distr_10_39
#SBATCH --nodes=1
#SBATCH --ntasks=64
#SBATCH --time=336:00:00
#SBATCH --mem=50G
#SBATCH --partition=production
#SBATCH --output=stdout_taxonomy_distr_10_39_%j.out
#SBATCH --error=stderr_taxonomy_distr_10_39_%j.err
...
name=`sed "${SLURM_ARRAY_TASK_ID}q;d" samples_10_39.txt`
