...
#SBATCH --job-name=taxonomy_distr
#SBATCH --nodes=1
#SBATCH --ntasks=64
#SBATCH --time=168:00:00
#SBATCH --mem=50G
#SBATCH --partition=production
#SBATCH --output=stdout_taxonomy_distr_%j.out
#SBATCH --error=stderr_taxonomy_distr_%j.err
#SBATCH --array=1-35 # this specifies the number of jobs to run in array.. corresponds to the files in my directory
