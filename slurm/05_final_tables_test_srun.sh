...
for name in 6 7 8 30 33 34 35 36 37 38 39
do
    echo $name
...
# qiime feature-table transpose \
#   --i-table ./dada2_table_fd_4.qza \
#   --o-transposed-feature-table ./transposed-table_fd_4.qza

# qiime metadata tabulate \
#   --m-input-file ./silva_taxonomy_fd_4.qza \
#   --m-input-file ./transposed-table_fd_4.qza \
#   --o-visualization ./merged-data_fd_4.qzv

# qiime tools export \
#   --input-path ./merged-data_fd_4.qzv \
#   --output-path ./merged-data_fd_4
